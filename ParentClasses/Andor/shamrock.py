...
#dll_location = os.path.join(dir_path, 'ShamrockDLLS\\atshamrock.dll')
#print(dll_location)
class Shamrock:
    def __init__(self):
        #for Windows
        ...
        dir_path = os.path.dirname(os.path.realpath(__file__))
        dll_location = os.path.join(dir_path, 'atspectrograph.dll')
        self.dll = WinDLL(dll_location)
        ...
        self.pixel_width = 26 # um
        self.pixel_number = 1024
