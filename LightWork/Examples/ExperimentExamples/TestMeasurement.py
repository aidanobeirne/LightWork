...
scanner1 = TestScanObject(
    name='1', scan_values=np.arange(0, 10, 1), scan_nest_index=0)
scanner2 = TestScanObject(
    name='2', scan_values=np.arange(10, 20, 1), scan_nest_index=0)
scanner3 = TestScanObject(
    name='3', scan_values=np.arange(30, 31, 0.1), scan_nest_index=1)
scanner4 = TestScanObject(name='4', scan_values=np.arange(
    0.1, 1.2, 0.2), scan_nest_index=2)

Measurement = SimpleScan(
    measurement_instrument=measurer, scan_instruments=[
        scanner1, scanner2, scanner3], laser_shutter=False,
