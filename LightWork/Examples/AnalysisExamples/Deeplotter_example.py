...
# from utility import data_io
# from utility.deeplotter import data_analysis_lib_alex as dal
# from utility.deeplotter.Deeplotter_v02 import Deeplotter
# from itertools import product
# import pickle


# h.add_ref_or_dark_to_measurement(r"G:\My Drive\BP\Samples\Box 2\Sample LO\data\2022-08-19\LO_RC_1L_matrix.pkl", ref=,dark=)
# with open(r"G:\My Drive\BP\Samples\Box 2\Sample LO\data\2022-08-19\LO_RC_1L_matrix.pkl", 'rb') as f:
#     data = pickle.load(f)
# args = h.generate_deeplotter_input(measurement=data, x_key_list=['keithley_TG', 'voltage [V]'],  y_key_list=['keithley_BG', 'voltage [V]'], swap_domain_units=False)
# #%% Plot in Deeplotter
