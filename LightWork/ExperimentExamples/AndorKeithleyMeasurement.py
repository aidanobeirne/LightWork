...
cam = AndorMeasurementObject(exposure_in_s=1, vcent=135, vheight=21, AcquisitionMode=1, Readmode=3, temperature=-89, wait_to_cool=False, path_to_domain=None)
...
Measurement = SimpleScan(
     ...
     savepath=r"C:\Users\HeinzLab\Documents\Aidan\Test\{}/".format(date.today().strftime("%b-%d-%Y")),
